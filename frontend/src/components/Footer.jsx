      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-8 border-b border-neutral-700">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">LoanWatch</span>
            </div>
            <p className="text-neutral-400 text-sm mb-6 max-w-md">
              LoanWatch is a comprehensive platform for fair loan approval prediction with built-in bias detection and mitigation. We help financial institutions ensure their lending practices are both accurate and fair across different demographic groups.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-neutral-500">
            &copy; {currentYear} LoanWatch. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex items-center">
            <span className="text-xs text-neutral-500 mr-2">Powered by</span>
            <a href="https://groq.com" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white">
              <svg className="h-5" viewBox="0 0 80 24" fill="currentColor">
                <path d="M16.2,6.4h-4.8c-3.3,0-6,2.7-6,6v0c0,3.3,2.7,6,6,6h4.8c3.3,0,6-2.7,6-6v0C22.2,9.1,19.5,6.4,16.2,6.4z M16.2,14.4h-4.8c-1.1,0-2-0.9-2-2v0c0-1.1,0.9-2,2-2h4.8c1.1,0,2,0.9,2,2v0C18.2,13.5,17.3,14.4,16.2,14.4z"/>
                <path d="M34.8,6.4H30c-3.3,0-6,2.7-6,6v0c0,3.3,2.7,6,6,6h4.8c3.3,0,6-2.7,6-6v0C40.8,9.1,38.1,6.4,34.8,6.4z M34.8,14.4H30c-1.1,0-2-0.9-2-2v0c0-1.1,0.9-2,2-2h4.8c1.1,0,2,0.9,2,2v0C36.8,13.5,35.9,14.4,34.8,14.4z"/>
                <path d="M58.5,6.4h-4.8c-3.3,0-6,2.7-6,6v5.5h4v-5.5c0-1.1,0.9-2,2-2h4.8c1.1,0,2,0.9,2,2v5.5h4v-5.5C64.5,9.1,61.8,6.4,58.5,6.4z"/>
                <path d="M76.8,6.4H72c-3.3,0-6,2.7-6,6v0c0,3.3,2.7,6,6,6h4.8v-4h-4.8c-1.1,0-2-0.9-2-2v0c0-1.1,0.9-2,2-2h4.8V6.4z"/>
              </svg>
            </a>
          </div>
        </div>
